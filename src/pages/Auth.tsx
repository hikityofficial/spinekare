...
import { ShieldCheck, ArrowRight, Play, Eye, EyeOff } from 'lucide-react';
                ...
                <div className="w-full max-w-md relative z-10">
                    ...
                    <form onSubmit={handleAuth} className="space-y-5">
                        ...
                        <div>
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    className="w-full bg-bg-secondary border border-border rounded-radius-lg px-4 py-3 pr-12 text-text-primary focus:outline-none focus:border-accent-cyan focus:ring-1 focus:ring-accent-cyan transition-colors"
                                    placeholder="••••••••"
                                />
                                <button
                                    type="button"
                        ...
                        <button
                            ...
                            className={`w-full py-3.5 bg-bg-card border border-border hover:bg-bg-secondary text-text-primary font-bold rounded-radius-lg transition-colors flex items-center justify-center gap-2 ${(isLoading || isGoogleLoading) ? 'opacity-70 cursor-not-allowed' : ''}`}
                        >
                            {isGoogleLoading ? (
